...
cat(file = "cc_112022_int1.txt"," 
model {

# Model: cc_112022_int1
#
...
start <- Sys.time()
cc_112022_int1 <- jags(jags.data, inits, params, "cc_112022_int1.txt", n.chains = nc, n.adapt = na, n.iter = ni, n.burnin = nb, n.thin = nt, parallel = TRUE)
end <- Sys.time()

end - start

print(cc_112022_int1, 3)
