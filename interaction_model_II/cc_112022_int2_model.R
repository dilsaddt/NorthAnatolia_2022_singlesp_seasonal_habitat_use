...
# INTERACTION MODEL FOR THE SECOND ROUND OF REVISIONS AFTER J OF MAMMALOGY REVISION
# INT2: season*elevation
...
cat(file = "cc_112022_int2_alphap.txt"," 
model {

# Model: cc_112022_int2_alphap
#
...
start <- Sys.time()
cc_112022_int2_alphap <- jags(jags.data, inits, params, "cc_112022_int2_alphap.txt", n.chains = nc, n.adapt = na, n.iter = ni, n.burnin = nb, n.thin = nt, parallel = TRUE)
end <- Sys.time()

end - start

print(cc_112022_int2_alphap, 3)
